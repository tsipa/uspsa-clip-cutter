...
def run(
    ...
    start_padding: float = typer.Option(10.0, help="Seconds to include before the detected start (beep or 'are you ready')."),
    end_padding: float = typer.Option(10.0, help="Seconds to include after the detected end command."),
